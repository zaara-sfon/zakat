...
const getThemeDescription = (themeName: ThemeName): string => {
  const descriptions: Record<ThemeName, string> = {
    ...
    CosmicOrange: 'Vibrant & energetic',
    LightGreen: 'Natural & organic',
    Red: 'Powerful & striking',
    SunsetOrange: 'Warm & artistic',
    OceanBlue: 'Calm & serene',
    Pastel: 'Soft & soothing',
    Earthy: 'Cozy & inviting',
